...
//no kernel needed as we simply call thrust
...
int main(int argc, char* argv[])
{
    ...
    **********************************/
    ...
    // allocate device memory (more precisely: copy host array to vector on device)
    thrust::device_vector<int> d_vector(array, array + size); 

    // http://docs.nvidia.com/cuda/thrust/ calling sort according to CUDA Toolkit Documentation but with vector as an argument
